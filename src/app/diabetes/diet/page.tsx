...
const faqs = [
  ...
  {
    question: "मिलेट्स किंवा गूळ साखरेपेक्षा सुरक्षित आहेत का?",
    answer:
      "मिलेट्समध्ये उपयुक्त पोषक घटक असू शकतात, पण त्यातही कर्बोदके असतात; प्रमाण महत्त्वाचे आहे. गूळ, मध आणि साखर या सर्वांमुळे रक्तातील ग्लुकोज वाढू शकतो. त्यामुळे ‘नैसर्गिक’ म्हणून अमर्याद सेवन करणे योग्य नाही.",
  },
  {
      ...
      <article className="mt-8">
        ...
        <div className="mt-12 space-y-10 text-base leading-8 text-slate-700 dark:text-slate-300">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border-2 border-emerald-300 bg-emerald-50 p-5 dark:border-emerald-800 dark:bg-emerald-950/30 sm:col-span-2">
                ...
                <p className="mt-2 text-sm leading-7 text-emerald-900 dark:text-emerald-200">
                  मेथी, पालक, शेपू, भेंडी, गवार, दोडका, दुधी भोपळा, कोबी, फ्लॉवर, वांगी, काकडी, टोमॅटो किंवा कोशिंबीर. बटाटा, रताळे, सुरण आणि मका या भागात मोजू नका; त्यात कर्बोदके तुलनेने जास्त असतात.
                </p>
              </div>
          ...
          <section>
            ...
            <div className="mt-5 grid gap-4">
              {[
                ...
                ["फक्त पोहे, उपमा किंवा साबुदाणा", "प्रमाण मर्यादित ठेवा आणि त्यात भरपूर भाज्या जोडा; सोबत उसळ, साखर नसलेले दही किंवा अंड्यासारखा प्रथिनांचा स्रोत घ्या."],
                ["गोड चहा, शीतपेय किंवा फळांचा रस", "साखर न घातलेला चहा, ताक किंवा पाणी निवडा. फळांचा रस घेण्याऐवजी योग्य प्रमाणात संपूर्ण फळ खा."],
                ["बिस्किटे, चिवडा किंवा तळलेला नाश्ता", "भूक आणि औषधांच्या वेळेनुसार भाजलेले हरभरे, थोडे शेंगदाणे, मोड आलेली कडधान्ये, साखर नसलेले दही किंवा संपूर्ण फळ विचारात घ्या."],
                ["‘डायबेटिक’ किंवा ‘शुगर-फ्री’ पॅकेट", "लेबलवरील एकूण कर्बोदके, संपृक्त मेद (Saturated fat), मीठ आणि एका वेळी खायचे दिलेले प्रमाण तपासा. केवळ पुढील बाजूवरील दाव्यावर विश्वास ठेवू नका."],
              ].map(([before, after]) => (
          ...
          <section>
            ...
            <p className="mt-4">
              हा वैयक्तिक आहारतक्ता किंवा ठरावीक प्रमाणाची चिठ्ठी नाही. घरातील उपलब्ध पदार्थ संतुलित ताटात कसे जोडता येतील याची उदाहरणे आहेत.
            </p>
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {[
                ["न्याहारी", "भाज्या घातलेले पोहे किंवा उपमा + उसळ/दही/अंडे; किंवा भाज्यांसोबत ज्वारीचे थालीपीठ आणि साखर नसलेले दही."],
                ["दुपारचे जेवण", "अर्धे ताट भाजी व कोशिंबीर + डाळ/उसळ किंवा इतर प्रथिनांचा स्रोत + योग्य प्रमाणात पोळी, भाकरी किंवा भात + साखर नसलेले ताक."],
                ["गरज असल्यास मधला खाऊ", "संपूर्ण फळ, भाजलेले हरभरे, थोडे शेंगदाणे किंवा साखर नसलेले दही. नाश्ता आवश्यक आहे की नाही हे औषधे आणि भुकेनुसार ठरते."],
          ...
          <section>
            ...
            <ol className="mt-5 space-y-3 pl-5">
              ...
              <li className="list-decimal pl-1 marker:font-bold marker:text-emerald-700">एकाच पदार्थानंतर वारंवार साखर जास्त दिसत असल्यास आधी प्रमाण आणि ताटातील जोड तपासा.</li>
        ...
        <RelatedLinks
          ...
          links={[
            ...
            {
              href: "/millets",
              title: "मिलेट्स मार्गदर्शक",
              description: "मिलेट्सचे प्रकार आणि आहारातील त्यांचे स्थान जाणून घ्या.",
            },
          ]}
        />
